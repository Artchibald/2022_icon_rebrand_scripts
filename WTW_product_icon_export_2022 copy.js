...
let violetIndex = 0; //these are for converting to inverse and inactive versions, corresponds to position in the array
let grayIndex = 1; //corresponds to position in the array
let whiteIndex = 5; //corresponds to position in the array
...
let rgbName = "RGB";
let cmykName = "CMYK";
let whiteColorName = "onFFF";
let transparentColorName = "TransparentBackground";
//Folder creations
let pngName = "png";
let jpgName = "jpg";
let svgName = "svg";
 ...
 ***********************************/
   ...
   try {
      ...
      new Folder(`${sourceDoc.path}/${coreName}/${whiteColorName}`).create();
      new Folder(`${sourceDoc.path}/${coreName}/${transparentColorName}`).create();
      new Folder(`${sourceDoc.path}/${coreName}/${whiteColorName}/${epsName}`).create();
      new Folder(`${sourceDoc.path}/${coreName}/${whiteColorName}/${jpgName}`).create();
      new Folder(`${sourceDoc.path}/${coreName}/${whiteColorName}/${pngName}`).create();
      new Folder(`${sourceDoc.path}/${coreName}/${whiteColorName}/${svgName}`).create();
      new Folder(`${sourceDoc.path}/${coreName}/${transparentColorName}/${epsName}`).create();
      new Folder(`${sourceDoc.path}/${coreName}/${transparentColorName}/${pngName}`).create();
      new Folder(`${sourceDoc.path}/${coreName}/${transparentColorName}/${svgName}`).create();
   ...
   // Archie Notes: successfully created a new fourth artboard with above code 
   ...
   for (let i = 0; i < exportSizes.length; i++) {
      ...
      let destFile = new File(Folder(`${sourceDoc.path}/${coreName}/${transparentColorName}/${pngName}`) + filename);
   ...
   for (let i = 0; i < exportSizes.length; i++) {
      ...
      let destFile = new File(Folder(`${sourceDoc.path}/${coreName}/${transparentColorName}/${svgName}`) + filename);
      CSTasks.scaleAndExportCoreSVG(rgbDoc, destFile, svgCoreStartWidth);
   }
   ...
   for (let i = 0; i < exportSizes.length; i++) {
      ...
      let destFile = new File(Folder(`${sourceDoc.path}/${coreName}/${whiteColorName}/${jpgName}`) + filename);
   ...
   let destFile = new File(Folder(`${sourceDoc.path}/${coreName}/${whiteColorName}/${epsName}`) + filename);
   ...
   let inverseFile = new File(Folder(`${sourceDoc.path}/${coreName}/${whiteColorName}/${epsName}`) + inverseFilename);
   ...
   let inactiveFile = new File(Folder(`${sourceDoc.path}/${coreName}/${whiteColorName}/${epsName}`) + inactiveFilename);
   ...
   let cmykDestFile = new File(Folder(`${sourceDoc.path}/${coreName}/${whiteColorName}/${epsName}`) + cmykFilename);
   ...
   let cmykInverseFile = new File(Folder(`${sourceDoc.path}/${coreName}/${whiteColorName}/${epsName}`) + cmykInverseFilename);
   ...
   let mastDestFile = new File(Folder(`${sourceDoc.path}/${coreName}/${whiteColorName}/${epsName}`) + mastFilename);
